...
main = Tk()
main.title('Poornima Student Management System')
main.geometry('1000x600')
main.resizable(1500, 1000)

# Creating the background and foreground color variables
lf_bg = 'purple' # bg color for the left_frame
...
Label(main, text="POORNIMA STUDENT MANAGEMENT SYSTEM", font=headlabelfont, bg='lightblue').pack(side=TOP, fill=X)
...
Label(right_frame, text='Students Records', font=headlabelfont, bg='indigo', fg='LightCyan').pack(side=TOP, fill=X)
